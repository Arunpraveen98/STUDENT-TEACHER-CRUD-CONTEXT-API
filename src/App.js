...
import AddTeacherData from "./components/TEACHER/AddTeacher";
import EditTeacherData from "./components/TEACHER/EditTeacher";
import { Teacherdetails } from "./components/TEACHER/TeacherDetails";
import SelectedTeacherProfile from "./components/TEACHER/TeacherProfile";
...
function App() {
  ...
  return (
    ...
    <context_Api.Provider
      value={{ Student_data, setStudent_data, Teacher_data, setTeacher_data }}
    >
      <div className="App">
        ...
        <Switch>
          ...
          {/* -------------------------- */}
          {/* ADD TEACHER DATA page */}
          <Route path="/addTeacherData">
            <BaseRender Title="ADD TEACHER DATA" Sub_Title="">
              <AddTeacherData />
            </BaseRender>
          </Route>

          {/* EDIT TEACHER DATA page */}
          <Route path="/editTeacherProfile/:CardIndex">
            <BaseRender Title="EDIT TEACHER PROFILE" Sub_Title="">
              <EditTeacherData />
            </BaseRender>
          </Route>
          ...
          <Route path="/TeacherDetails">
            <BaseRender Title="TEACHERS LIST" Sub_Title="">
              <Teacherdetails />
            </BaseRender>
          </Route>

          {/* TEACHER PROFILE page */}
          <Route path="/TeacherSelectedProfile/:index">
            <BaseRender>
